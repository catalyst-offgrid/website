export interface Project {
   ...
   */
  logo?: string;
  /** 2-4 sentence description, verbatim from Wix HTML. */
  body: string;
...
export const projects: Project[] = [
  // ===== Enterprise Development =====
  {
    ...
    image: "get-invest.png", // composite image with logo baked in
  ...
  },
  {
    ...
    body: "Catalyst provides strategic advisory for Acumen's Hardest to Reach fund. This support includes guidance on pipeline for HTR debt and equity facilities, semi-annual \u201cstate of the industry\u201d updates, and advice on the design and deployment of technical assistance activities for companies qualified for financing under the program.",
    section: "enterprise",
  },
  {
    slug: "gogla-elevate",
    title: "GOGLA ELEVATE \u2014 Investor Readiness Training",
    image: "gogla-elevate.png", // composite image with logo baked in
  ...
  },
  {
    ...
    image: "mcfa.png", // composite image
  ...
  {
    slug: "get-invest-association-capacity",
  ...
  // ===== Strategy & Insights =====
  {
    ...
    image: "rockefeller-green-power.png", // composite image with title baked in
    body: "In 2024, Catalyst, in partnership with The Rockefeller Foundation, developed The Green Power Gap report to examine the energy shortfall across 72 developing countries and ideate innovative solutions for expanding clean energy access. The report highlights key policy and technology strategies to bypass fossil fuels, leapfrogging directly to clean energy systems that ensure sustainable growth and a resilient, energy abundant future.",
    section: "strategy",
  },
  {
    ...
    image: "brilho.jpg",
    body: "Since 2018, Catalyst has played a key role in supporting SNV's BRILHO program, which aims to catalyze Mozambique's off-grid energy market. Catalyst has supported the design and rollout of the Market Development Fund (which includes RBF, catalytic grants, and TA), implementation through due diligence of SHS, ICS, and mini-grid companies, as well as TA for distributors, and the drafting of BRILHO's flagship report, highlighting achievements in financing, policy reform, institutional strengthening, and demand activation.",
    section: "strategy",
  },
  {
    slug: "p3-geapp",
    ...
    image: "p3.jpg",
    body: "In 2022, Catalyst led the development of Powering People and Planet (P3), GEAPP's first annual impact report, launched at COP27. The report examines GEAPP's mission, impact methodology, and global projects, providing an evidence-based assessment of progress. It offers a candid look at impact results and issues a global call to action for expanding reliable, affordable clean energy in energy-poor countries to drive sustainable development and mitigate climate change.",
    section: "strategy",
  },
  {
    slug: "shell-sdg7",
