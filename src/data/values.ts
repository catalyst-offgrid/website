...
export const values: Value[] = [
  ...
  },
  {
    ...
    body: "We think in systems, not silos. We challenge the limits of the possible, innovating to reshape markets and drive sustainable change.",
  },
  {
  ...
  },
  {
    ...
    body: "We power the future for everyone. We prioritize inclusion and ensure the energy transition leaves no one behind.",
  },
];
